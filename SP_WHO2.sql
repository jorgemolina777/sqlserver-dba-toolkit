...
SELECT p.SPID,
       ...
       P.LASTBATCH
FROM   #SP_WHO2 P --(nolock)
WHERE  p.DBNAME like '%FNic_PArana_Cartera_Garantias%' OR p.DBNAME like '%cdr%'  --in ('FNic_Raul_Cartera_20160731','FNic_IMedrano_SIBOIF_2016')
--AND P.DBNAME != 'FNic_JMolina_CDR_SIBOIF_Ori'
--and P.PROGRAMNAME like '%.Net SqlClient Data Provider                                               %'
ORDER  BY P.LASTBATCH asc
